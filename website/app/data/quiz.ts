...
export const quizMeta = {
  ...
  resultDisclaimer:
    "Энэ үр дүн нь таны AI хэрэглээний ерөнхий чиглэлийг харуулах өөрөө үнэлгээ өгөх тест бөгөөд баталгаажсан мэргэжлийн үнэлгээ биш.",
  questionCount: 11,
  durationMinutes: 3,
  maximumScore: 33,
};
...
export const dimensionFeedback: Record<string, Record<string, string>> = {
  prompt_design: {
    ...
    capable:
      "Та ерөнхий хүсэлтийг тодорхой болгох чадвартай байна. Жишээ, хязгаарлалт болон үнэлгээний шалгуур нэмэх нь үр дүнг илүү тогтвортой болгоно.",
    developing:
  ...
  output_evaluation: {
    ...
    capable:
      "Та AI-ийн алдаа гаргах боломжийг ойлгож байна. Чухал мэдээлэлд тогтмол баталгаажуулах үйл явц ашиглавал илүү найдвартай болно.",
    developing:
  ...
  responsible_use: {
    strong:
      "Та нууц мэдээлэл болон өндөр нөлөөтэй шийдвэрт хүний хяналт, өгөгдлийн бодлого болон эрсдэлийн үнэлгээ шаардлагатайг сайн ойлгож байна.",
    capable:
      "Та нууцлал болон хүний хяналтын ач холбогдлыг мэддэг. Байгууллагын бодлого болон тухайн хэрэгслийн өгөгдлийн нөхцөлийг тогтмол шалгах нь дараагийн алхам.",
    developing:
  ...
  workflow_automation: {
    ...
    capable:
      "Та давтагдах ажлыг бүтэцжүүлэх ойлголттой байна. Онцгой нөхцөл болон хүний хяналтыг тодорхой болговол workflow илүү найдвартай болно.",
    developing:
...
export const resultLevels: ResultLevel[] = [
  ...
  },
  {
    ...
    nextSteps: [
      ...
      "Output quality шалгах үнэлгээний шалгуур ашиглах",
  ...
  },
  {
    ...
    nextSteps: [
      ...
      "Automation-ийн алдаа, exception болон хүний хяналтыг төлөвлөх",
      "AI хэрэглээний цаг, чанар болон үр дүнг хэмжих",
    ],
    accuracyNote:
      "Энэ түвшин нь таныг AI expert гэж батлахгүй. Олон сонголттой асуултаар зөв зарчмыг таних чадварыг үнэлсэн үр дүн гэж тайлбарлана.",
  },
];
...
export const questions: QuizQuestion[] = [
  {
    ...
    options: [
      ...
      { id: "B", label: "Хэт өндөр тоог ер бусын утга гэж үзээд хасах", score: 2 },
      {
        id: "C",
        label:
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "C",
        label: "Удирдлагын хураангуй гарга. Хүснэгт болон жагсаалтын тэмдэг ашигла.",
        score: 2,
      },
      {
        id: "D",
  ...
  },
  {
    ...
    options: [
      { id: "A", label: "Илүү бүтээлч, дээд зэргийн болго гэж хүсэх", score: 1 },
      {
        id: "B",
        label:
      ...
      { id: "C", label: "AI-д туршлагатай копирайтер гэсэн үүрэг өгөх", score: 2 },
      {
        id: "D",
  ...
  },
  {
    ...
    question:
      "Танай баг хэрэглэгчдийн худалдан авалтын түүхтэй хүснэгтийг AI-аар ангилуулах гэж байна. Хамгийн зөв эхний алхам аль вэ?",
    options: [
      {
        id: "A",
        label:
          "Ашиглах хэрэгслийн өгөгдлийн бодлого болон байгууллагын дүрмийг шалгаж, шаардлагатай мэдээллийг нэргүйжүүлэх",
        score: 3,
      },
      {
        id: "B",
  ...
  },
  {
    ...
    options: [
      { id: "A", label: "Хамгийн сайн бичдэг моделийг сонгох", score: 1 },
      { id: "B", label: "Хамгийн олон хэрэглэгчтэй AI хэрэгслийг ашиглах", score: 0 },
      {
        id: "C",
        label:
          "Веб эх сурвалж үзүүлдэг хэрэгслээр судалгаа хийж, өөр моделөөр бүтэц болон найруулгыг сайжруулах",
        score: 3,
      },
      {
        id: "D",
        label: "Нэг модель ашиглавал хариулт хоорондоо зөрөхгүй тул нэг хэрэгслээр бүхнийг хийх",
        score: 2,
      },
    ],
  },
    ...
    options: [
      {
        id: "A",
        label:
          "Файлын бүтэц, тооцоолол, гаралтын загвар болон хүний баталгаажуулалттай хагас автомат workflow хийх",
        score: 3,
      },
      {
        id: "B",
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        label: "Agent олон AI модель ашигладаг, automation нэг модель ашигладаг",
        score: 1,
      },
      {
        id: "B",
  ...
  },
  {
    ...
    options: [
      ...
      { id: "D", label: "Та дэлхийн шилдэг маркетингийн стратегич гэсэн үүрэг", score: 1 },
    ],
  },
  {
    id: "q10",
